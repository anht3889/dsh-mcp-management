...
```sh
npx @deepseek-ai/dsh plugin --profile web add @anht3889/dsh-mcp-mgmt-bundle@0.0.1
```
...
![Add MCP server](docs/assets/mcp-add-server.png)
...
![MCP Servers list](docs/assets/mcp-servers.png)
...
![MCP server details](docs/assets/mcp-server-details.png)
